package com.app.OddfoodyDriver.DotsProgressBar;
...
public class DilatingDotsProgressBar extends View {
    ...
    private static final double START_DELAY_FACTOR = 0.35;
    ...
    private void init(AttributeSet attrs) {
        ...
        mDotRadius = a.getDimension(R.styleable.DilatingDotsProgressBar_android_radius, 12);
