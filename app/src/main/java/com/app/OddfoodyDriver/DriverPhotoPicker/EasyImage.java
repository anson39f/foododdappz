package com.app.OddfoodyDriver.DriverPhotoPicker;
...
import static com.app.OddfoodyDriver.DriverPhotoPicker.EasyImageFiles.singleFileList;
...
public class EasyImage implements Constants {
    ...
    private static final String KEY_PHOTO_URI = "pl.aprilapps.ArabtyPhotoPicker.photo_uri";
    private static final String KEY_LAST_CAMERA_PHOTO = "pl.aprilapps.ArabtyPhotoPicker.last_photo";
    private static final String KEY_TYPE = "pl.aprilapps.ArabtyPhotoPicker.type";
